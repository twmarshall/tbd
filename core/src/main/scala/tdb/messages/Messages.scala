...
case class PutInMessage(listId: String, key: Any, column: String, value: Any)
case class PutAllMessage(listId: String, values: Iterable[(Any, Any)])
case class GetMessage(listId: String, key: Any, taskRef: ActorRef)
...
case class KeyUpdatedMessage(listId: String, key: Any)
case class KeyRemovedMessage(listId: String, key: Any)
